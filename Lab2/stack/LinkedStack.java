...
public class LinkedStack<E> implements Stack<E> {
  ...
  public void push(E element) {
    ...
    Node newNode = new Node<E>(element, tempNode);
    this.head = newNode;
    this.size++;
  }
  ...
  public E top() {
    ...
    return this.head.getElement(); // this is a dummy method now; it needs to be implemented <<<<<<<<<<<<<<<
  }
  ...
  public E pop() {
    ...
    E returnElem = this.head.getElement();
    this.head = this.head.next;
    size--;
    return returnElem; // this is a dummy method now; it needs to be implemented <<<<<<<<<<<<<<<
  }
